...
public class MaterialDialog {
    ...
    public MaterialDialog(Context context) {
        ...
        mLayoutParams.setMargins(dip2px(2), 0, dip2px(12), dip2px(BUTTON_BOTTOM));
    }
    ...
    private Button inflateButton(final View.OnClickListener listener) {
        Button button = (Button) View.inflate(mContext, R.layout.button_material_dialog, null);
    ...
    public MaterialDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mCancelOnTouch = cancel;
        if (mBuilder != null) {
            mBuilder.setCanceledOnTouchOutside(mCancelOnTouch);
        }
        return this;
    }
...
//7
            ...
            mAlertDialog.setCanceledOnTouchOutside(mCancelOnTouch);
