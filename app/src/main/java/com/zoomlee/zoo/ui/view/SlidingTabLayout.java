...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        horizontalPadding = getResources().getDimensionPixelSize(R.dimen.tab_layout_horizontal_padding);
        mTabStrip.setPadding(mTabStrip.getPaddingLeft() + horizontalPadding, mTabStrip.getPaddingTop(), mTabStrip.getPaddingRight() + horizontalPadding, mTabStrip.getPaddingBottom());
    ...
    private void scrollToTab(int tabIndex, int positionOffset) {
        ...
        if (selectedChild != null) {
            ...
            scrollTo(targetScrollX - horizontalPadding, 0);
        }
    }
